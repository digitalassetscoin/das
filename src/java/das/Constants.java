...
public final class Constants {
    ...
    public static final boolean isTestnet = Das.getBooleanProperty("das.isTestnet");
    public static final boolean isOffline = Das.getBooleanProperty("das.isOffline");
    public static final boolean isLightClient = Das.getBooleanProperty("das.isLightClient");

    public static final int MAX_NUMBER_OF_TRANSACTIONS = 255;
    public static final int MIN_TRANSACTION_SIZE = 176;
    public static final int MAX_PAYLOAD_LENGTH = MAX_NUMBER_OF_TRANSACTIONS * MIN_TRANSACTION_SIZE;
    public static final long MAX_BALANCE_DAS = 1000000000;
    public static final long ONE_DAS = 100000000;
    public static final long MAX_BALANCE_NQT = MAX_BALANCE_DAS * ONE_DAS;
    public static final long INITIAL_BASE_TARGET = 153722867;
    public static final long MAX_BASE_TARGET = MAX_BALANCE_DAS * INITIAL_BASE_TARGET;
    ...
    public static final int MAX_ROLLBACK = Math.max(Das.getIntProperty("das.maxRollback"), 35);
    public static final int GUARANTEED_BALANCE_CONFIRMATIONS = isTestnet ? Das.getIntProperty("das.testnetGuaranteedBalanceConfirmations", 60) : 60;
    public static final int LEASING_DELAY = isTestnet ? Das.getIntProperty("das.testnetLeasingDelay", 1440) : 1440;
    public static final long MIN_FORGING_BALANCE_NQT = 50000 * ONE_DAS;
    public static final long NUMERATOR_FEE = 1;
    public static final long DENOMINATOR_FEE = 50;

    public static final int MAX_TIMEDRIFT = 15; // allow up to 15 s clock difference
    public static final int FORGING_DELAY = Das.getIntProperty("das.forgingDelay");
    public static final int FORGING_SPEEDUP = Das.getIntProperty("das.forgingSpeedup");
    ...
    static {
        int maxPrunableLifetime = Das.getIntProperty("das.maxPrunableLifetime");
        ENABLE_PRUNING = maxPrunableLifetime >= 0;
        MAX_PRUNABLE_LIFETIME = ENABLE_PRUNING ? Math.max(maxPrunableLifetime, MIN_PRUNABLE_LIFETIME) : Integer.MAX_VALUE;
    }
    public static final boolean INCLUDE_EXPIRED_PRUNABLE = Das.getBooleanProperty("das.includeExpiredPrunable");
    ...
    public static final int ASSET_ISSUANCE_FEE = 5000;
    ...
    static final long UNCONFIRMED_POOL_DEPOSIT_NQT = (isTestnet ? 50 : 100) * ONE_DAS;
    public static final long SHUFFLING_DEPOSIT_NQT = (isTestnet ? 7 : 1000) * ONE_DAS;

    public static final boolean correctInvalidFees = Das.getBooleanProperty("das.correctInvalidFees");
