...
public interface TransactionProcessor extends Observable<List<? extends Transaction>,TransactionProcessor.Event> {
    ...
    void broadcast(Transaction transaction) throws DasException.ValidationException;

    void processPeerTransactions(JSONObject request) throws DasException.ValidationException;
    ...
    List<Transaction> restorePrunableData(JSONArray transactions) throws DasException.NotValidException;
}
