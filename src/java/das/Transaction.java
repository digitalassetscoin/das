...
public interface Transaction {
    ...
    interface Builder {
        ...
        Transaction build() throws DasException.NotValidException;

        Transaction build(String secretPhrase) throws DasException.NotValidException;
    ...
    void validate() throws DasException.ValidationException;
