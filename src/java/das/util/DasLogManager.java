...
/**
 * Java LogManager extension for use with Das
 */
public class DasLogManager extends LogManager {

    /** Logging reconfiguration in progress */
    private volatile boolean loggingReconfiguration = false;

    /**
     * Create the Das log manager
     *
     ...
     * done terminating the Das processes.
     */
    public DasLogManager() {
        super();
    }
     ...
     * This allows us to continue to use logging facilities during Das shutdown.
     */
    @Override
    public void reset() {
    ...
    /**
     * Das shutdown is now complete, so call LogManager.reset() to terminate
     * the log handlers.
     */
    void dasShutdown() {
        super.reset();
