...
public final class Convert {
    ...
    public static String rsAccount(long accountId) {
        return "DAS-" + Crypto.rsEncode(accountId);
    }
    ...
    public static String readString(ByteBuffer buffer, int numBytes, int maxLength) throws DasException.NotValidException {
        if (numBytes > 3 * maxLength) {
            throw new DasException.NotValidException("Max parameter length exceeded");
        }
    ...
    public static long parseDAS(String das) {
        return parseStringFraction(das, 8, Constants.MAX_BALANCE_DAS);
    }
