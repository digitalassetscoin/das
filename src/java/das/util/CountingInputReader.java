...
import das.DasException.DasIOException;
...
public class CountingInputReader extends FilterReader {
     ...
     * @throws  DasIOException      Maximum count exceeded
     */
    private void incCount(long c) throws DasIOException {
        count += c;
        if (count > limit)
            throw new DasIOException("Maximum size exceeded: " + count);
    }
}
