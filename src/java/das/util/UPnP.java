...
public class UPnP {
    ...
    private static void init() {
        ...
        try {
            ...
            GatewayDevice.setHttpReadTimeout(Das.getIntProperty("das.upnpGatewayTimeout", GatewayDevice.getHttpReadTimeout()));
            GatewayDiscover discover = new GatewayDiscover();
            discover.setTimeout(Das.getIntProperty("das.upnpDiscoverTimeout", discover.getTimeout()));
