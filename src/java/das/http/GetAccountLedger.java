 ...
 * account ledger tracks all account changes as determined by the das.ledgerAccounts,
 * das.ledgerLogUnconfirmed and das.ledgerTrimKeep properties.
 * </p>
 * <table>
 ...
 *           The administrator password is required if more than das.maxAPIRecords entries are to be searched.
 *       </td>
 *     </tr>
 *     <tr>
 *       <td>event</td>
 ...
 *           The maximum number of entries returned is limited by the das.maxAPIRecords property
 ...
 *     <tr>
 *       <td>DAS_BALANCE</td>
 *       <td>Change in the DAS balance for the account.  There is no 'holding'.</td>
 *     </tr>
 *     <tr>
 ...
 *     </tr>
 *     <tr>
 *       <td>UNCONFIRMED_DAS_BALANCE</td>
 *       <td>Change in the unconfirmed DAS balance for the account.  There is no 'holding'.</td>
 *     </tr>
 *   </tbody>
 * </table>
 */
public class GetAccountLedger extends APIServlet.APIRequestHandler {
     ...
     * @return                      API response
     * @throws  DasException        Invalid request
     */
    @Override
