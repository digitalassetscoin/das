...
import das.http.EventListener.PendingEvent;
 ...
 * das.apiEventTimeout will be used if no timeout value is specified or
 * if the requested timeout is greater than das.apiEventTimeout.</li>
 * </ul>
 *
