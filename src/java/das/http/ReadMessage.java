...
import static das.http.JSONResponses.NO_MESSAGE;
import static das.http.JSONResponses.PRUNED_TRANSACTION;
import static das.http.JSONResponses.UNKNOWN_TRANSACTION;
...
public final class ReadMessage extends APIServlet.APIRequestHandler {
    ...
    protected JSONStreamAware processRequest(HttpServletRequest req) throws ParameterException {
        ...
        Transaction transaction = Das.getBlockchain().getTransaction(transactionId);
        if (transaction == null) {
