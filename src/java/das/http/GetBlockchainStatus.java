...
public final class GetBlockchainStatus extends APIServlet.APIRequestHandler {
    ...
    protected JSONObject processRequest(HttpServletRequest req) {
        ...
        response.put("application", Das.APPLICATION);
        response.put("version", Das.VERSION);
        response.put("time", Das.getEpochTime());
        ...
        response.put("currentMinRollbackHeight", Das.getBlockchainProcessor().getMinRollbackHeight());
