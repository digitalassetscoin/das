...
import static das.http.JSONResponses.INCORRECT_DELIVERY_DEADLINE_TIMESTAMP;
import static das.http.JSONResponses.INCORRECT_PURCHASE_PRICE;
import static das.http.JSONResponses.INCORRECT_PURCHASE_QUANTITY;
import static das.http.JSONResponses.MISSING_DELIVERY_DEADLINE_TIMESTAMP;
import static das.http.JSONResponses.UNKNOWN_GOODS;
...
public final class DGSPurchase extends CreateTransaction {
    ...
    protected JSONStreamAware processRequest(HttpServletRequest req) throws DasException {
        ...
        try {
            ...
            if (deliveryDeadline <= Das.getEpochTime()) {
