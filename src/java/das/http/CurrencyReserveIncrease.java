...
/**
 * Increase the value of currency units by paying DAS
 * <p>
 * Parameters
 * <ul>
 ...
 * Constraints
 * <p>
 * This API is allowed only when the currency is {@link das.CurrencyType#RESERVABLE} and is not yet active.
 * <p>
 ...
 * The list of founders and their NQT investment can be obtained using the {@link das.http.GetCurrencyFounders} API.
 */
