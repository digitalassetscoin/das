...
public class APITestServlet extends HttpServlet {
    ...
    private static final String header1 =
            ...
            "           <a class='navbar-brand' href='/test'>Das http API</a>\n" +
            "       </div>\n" +
            ...
            "               <li><a href='https://daswiki.org/wiki/The_Das_API' target='_blank' style='margin-left:20px;'>Wiki Docs</a></li>\n" +
            "           </ul>\n" +
            "       </div>\n" +
            "   </div>\n" +
            "</div>\n" +
    ...
    private static String form(HttpServletRequest req, String requestType, boolean singleView, APIServlet.APIRequestHandler requestHandler) {
        ...
        buf.append("<a style='font-weight:normal;font-size:14px;color:#777;' href='https://daswiki.org/wiki/The_Das_API#");
        ...
        String formAction = "/test-proxy".equals(path) ? "/das-proxy" : "/das";
