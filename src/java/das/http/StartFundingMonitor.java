...
import static das.http.JSONResponses.MONITOR_ALREADY_STARTED;
import static das.http.JSONResponses.UNKNOWN_ACCOUNT;
import static das.http.JSONResponses.incorrect;

/**
 * Start a funding monitor
 * <p>
 * A funding monitor will transfer DAS, ASSET or CURRENCY from the funding account
 ...
 * <p>
 * DAS amounts are specified with 8 decimal places.  Asset and Currency decimal places
...
public final class StartFundingMonitor extends APIServlet.APIRequestHandler {
     ...
     * @throws  DasException        Unable to process request
     */
    @Override
