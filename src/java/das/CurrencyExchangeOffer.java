...
public abstract class CurrencyExchangeOffer {
    ...
    static void exchangeCurrencyForDAS(Transaction transaction, Account account, final long currencyId, final long rateNQT, final long units) {
    ...
    static void exchangeDASForCurrency(Transaction transaction, Account account, final long currencyId, final long rateNQT, final long units) {
    ...
    CurrencyExchangeOffer(long id, long currencyId, long accountId, long rateNQT, long limit, long supply,
        ...
        this.creationHeight = Das.getBlockchain().getHeight();
