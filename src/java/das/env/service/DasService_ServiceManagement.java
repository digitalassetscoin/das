...
package das.env.service;

import das.Das;
import das.env.LookAndFeel;

import javax.swing.*;

@SuppressWarnings("UnusedDeclaration")
public class DasService_ServiceManagement {
    ...
    public static String[] serviceGetInfo() {
        return new String[]{
                "DAS Server", // Long name
                "Manages the DAS cryptographic currency protocol", // Description
                "true", // IsAutomatic
                "true", // IsAcceptStop
                "", // failure exe
                "", // args failure
    ...
    public static boolean serviceIsCreate() {
        return JOptionPane.showConfirmDialog(null, "Do you want to install the DAS service ?", "Create Service", JOptionPane.YES_NO_OPTION) == JOptionPane.YES_OPTION;
    }
    ...
    public static boolean serviceIsDelete() {
        return JOptionPane.showConfirmDialog(null, "This DAS service is already installed. Do you want to delete it ?", "Delete Service", JOptionPane.YES_NO_OPTION) == JOptionPane.YES_OPTION;
    }
