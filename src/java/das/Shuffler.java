...
public final class Shuffler {
    ...
    private static final int MAX_SHUFFLERS = Das.getIntProperty("das.maxNumberOfShufflers");
    ...
    private static void scheduleExpiration(Shuffling shuffling) {
        int expirationHeight = Das.getBlockchain().getHeight() + 720;
    ...
    private volatile DasException.NotCurrentlyValidException failureCause;
    ...
    public DasException.NotCurrentlyValidException getFailureCause() {
        return failureCause;
    }
    ...
    private void submitTransaction(Attachment.ShufflingAttachment attachment) {
        ...
        try {
            Transaction.Builder builder = Das.newTransactionBuilder(Crypto.getPublicKey(secretPhrase), 0, 0,
                    (short) 1440, attachment);
            builder.timestamp(Das.getBlockchain().getLastBlockTimestamp());
            ...
            if (participantAccount == null || transaction.getFeeNQT() > participantAccount.getUnconfirmedBalanceNQT()) {
                ...
                failureCause = new DasException.NotCurrentlyValidException("Insufficient balance");
    ...
    public static class ShufflerException extends DasException {
