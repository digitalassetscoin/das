...
import das.Das;
import das.env.service.DasService_ServiceManagement;
...
public class ManifestGenerator {
    ...
    public static void main(String[] args) {
        ...
        manifestGenerator.generate("./resource/das.manifest.mf", Das.class.getCanonicalName(), "./lib");
        String serviceClassName = DasService_ServiceManagement.class.getCanonicalName();
        serviceClassName = serviceClassName.substring(0, serviceClassName.length() - "_ServiceManagement".length());
        manifestGenerator.generate("./resource/dasservice.manifest.mf", serviceClassName, "./lib");
    }
