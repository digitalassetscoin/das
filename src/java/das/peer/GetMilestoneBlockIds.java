    ...
    JSONStreamAware processRequest(JSONObject request, Peer peer) {
        ...
        try {
            ...
            if (lastBlockIdString != null) {
                ...
                long myLastBlockId = Das.getBlockchain().getLastBlock().getId();
                if (myLastBlockId == lastBlockId || Das.getBlockchain().hasBlock(lastBlockId)) {
            ...
            if (lastMilestoneBlockIdString != null) {
                Block lastMilestoneBlock = Das.getBlockchain().getBlock(Convert.parseUnsignedLong(lastMilestoneBlockIdString));
            ...
            blockId = Das.getBlockchain().getBlockIdAtHeight(height);
