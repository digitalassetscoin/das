...
import static das.user.JSONResponses.DENY_ACCESS;
import static das.user.JSONResponses.INCORRECT_REQUEST;
import static das.user.JSONResponses.POST_REQUIRED;

public final class UserServlet extends HttpServlet  {

    abstract static class UserRequestHandler {
        abstract JSONStreamAware processRequest(HttpServletRequest request, User user) throws DasException, IOException;
        boolean requirePost() {
            return false;
        }
    }

    private static final boolean enforcePost = Das.getBooleanProperty("das.uiServerEnforcePOST");
    ...
    private void process(HttpServletRequest req, HttpServletResponse resp) throws IOException {
        ...
        } catch (RuntimeException|DasException e) {
