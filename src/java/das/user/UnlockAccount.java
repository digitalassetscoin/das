...
import static das.user.JSONResponses.LOCK_ACCOUNT;
...
public final class UnlockAccount extends UserServlet.UserRequestHandler {
    ...
    JSONStreamAware processRequest(HttpServletRequest req, User user) throws IOException {
        ...
        if (account == null) {
            ...
            try (DbIterator<? extends Transaction> transactions = Das.getTransactionProcessor().getAllUnconfirmedTransactions()) {
            ...
            int blockchainHeight = Das.getBlockchain().getLastBlock().getHeight();
            try (DbIterator<? extends Block> blockIterator = Das.getBlockchain().getBlocks(accountId, 0)) {
            ...
            try (DbIterator<? extends Transaction> transactionIterator = Das.getBlockchain().getTransactions(accountId, (byte) -1, (byte) -1, 0, false)) {
