...
public abstract class DasException extends Exception {
    ...
    protected DasException() {
        super();
    }

    protected DasException(String message) {
        super(message);
    }

    protected DasException(String message, Throwable cause) {
        super(message, cause);
    }

    protected DasException(Throwable cause) {
        super(cause);
    }

    public static abstract class ValidationException extends DasException {
    ...
    public static final class DasIOException extends IOException {

        public DasIOException(String message) {
            super(message);
        }

        public DasIOException(String message, Throwable cause) {
            super(message, cause);
        }
