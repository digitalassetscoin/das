...
import das.crypto.AnonymouslyEncryptedData;
...
public final class Shuffling {
    ...
    private static final boolean deleteFinished = Das.getBooleanProperty("das.deleteFinishedShufflings");
    ...
    private void cancel(Block block) {
        ...
        if (blamedAccountId != 0) {
            ...
            for (int i = 0; i < 3; i++) {
                ...
                Logger.logDebugMessage("Shuffling penalty %f DAS awarded to forger at height %d", ((double)fee) / Constants.ONE_DAS, block.getHeight() - i - 1);
            }
            ...
            Logger.logDebugMessage("Shuffling penalty %f DAS awarded to forger at height %d", ((double)fee) / Constants.ONE_DAS, block.getHeight());
        }
