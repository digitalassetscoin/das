...
import das.Das;
import das.http.APIServlet;
import das.http.APITag;
...
public final class AddOns {
    ...
    static {
        ...
        Das.getStringListProperty("das.addOns").forEach(addOn -> {
            try {
        ...
        if (!addOns.isEmpty() && !Das.getBooleanProperty("das.disableSecurityPolicy")) {
            System.setProperty("java.security.policy", Das.isDesktopApplicationEnabled() ? "dasdesktop.policy" : "das.policy");
