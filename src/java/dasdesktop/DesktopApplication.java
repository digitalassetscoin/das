...
public class DesktopApplication extends Application {
    ...
    public void start(Stage stage) throws Exception {
        ...
        webEngine.setUserDataDirectory(Das.getConfDir());
        ...
        loadWorker.stateProperty().addListener(
                (ov, oldState, newState) -> {
                    ...
                    stage.setTitle("DAS Desktop - " + webEngine.getLocation());
                    nrs = (JSObject) webEngine.executeScript("NRS");
                    updateClientState("Desktop Wallet started");
                    BlockchainProcessor blockchainProcessor = Das.getBlockchainProcessor();
                    ...
                    Das.getTransactionProcessor().addListener((transaction) ->
        ...
        stage.getIcons().add(new Image(address + "/img/das-icon-32x32.png"));
    ...
    private static String getUrl() {
        ...
        String defaultAccount = Das.getStringProperty("das.defaultDesktopAccount");
    ...
    private void download(String requestType, Map<String, String> params) {
        ...
        if (requestType.equals("downloadTaggedData")) {
            if (taggedData == null && retrieve) {
                try {
                    if (Das.getBlockchainProcessor().restorePrunedTransaction(transactionId) == null) {
