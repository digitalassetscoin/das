...
### Usable URLs ###
  ...
  - **API** - http://localhost:2346/test
  - **DB Interface** - http://localhost:2346/dbshell
  - **Java Class Browser** - http://localhost:2346/doc

### Database ###
  
  - H2 embedded database
  - main database: `das_db/`
  - test database: `das_test_db/`
  ...
  - use the das.db framework when accessing the database from your code
...
### Testing ###
  ...
  - all API calls can be tested manually from the auto-generated http://localhost:2346/test page
...
- https://crowdin.com/project/das-ui-translation
...
The DAS wallet UI run as a mobile app.
...
6. Under the <DASRoot>\mobile\app folder execute the command:
createapp.bat
