...
/*
    DAS address class, extended version (with error guessing).

    Version: 1.0, license: Public Domain, coder: DasChg (admin@daschg.com).
*/
...
function DasAddress() {
	...
	this.set = function(adr, allow_accounts) {
		...
		if (adr.indexOf('DAS-') == 0) adr = adr.substr(4);
