...
var NRS = (function(NRS, $, undefined) {
    ...
    $("#dividend_payment_amount_per_share, #dividend_payment_height").on("blur", function() {
        ...
        var amountDASPerShare = $modal.find("#dividend_payment_amount_per_share").val();
        ...
        if (amountDASPerShare && /^\d+$/.test(height)) {
            NRS.getAssetAccounts(NRS.getCurrentAsset().asset, height,
                function (response) {
                    ...
                    var priceNQT = new BigInteger(NRS.calculatePricePerWholeQNT(NRS.convertToNQT(amountDASPerShare), NRS.getCurrentAsset().decimals));
                    var totalDAS = NRS.calculateOrderTotal(totalQuantityQNT, priceNQT);
