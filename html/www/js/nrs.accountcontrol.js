...
var NRS = (function(NRS, $) {
	...
	$("#set_mandatory_approval_modal").on("show.bs.modal", function(e) {
		...
		var context = {
			labelText: "Amount DAS",
			labelI18n: "amount_das",
			helpI18n: "approve_transaction_amount_help",
			inputName: "controlQuorumDAS",
			addonText: "DAS",
			addonI18n: "das_unit"
		}
		var $elems = NRS.initModalUIElement($modal, '.phasing_only_amount_das', 'simple_input_with_addon_modal_ui_element', context);
		...
		context['inputName'] = 'controlMinBalanceDAS';
		context['addonText'] = 'DAS';
		context['addonI18n'] = 'das_unit';
		var $elems = NRS.initModalUIElement($modal, '.phasing_only_min_balance_das', 'simple_input_with_addon_modal_ui_element', context);
		$elems.find('input').prop("disabled", true);
		$elems.hide();
