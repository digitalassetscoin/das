	...
	NRS.pages.news = function() {
      ...
      var settingsReddit = {
         ...
         "filter": function(entry, tokens) {
            return tokens.title.indexOf("Donations toward") == -1 && tokens.title.indexOf("DAS tipping bot has arrived") == -1
         },
         "ssl": ssl
      };

      $("#dasforum_news").rss("https://dasforum.org/index.php?type=rss;action=.xml", settings, NRS.newsLoaded);
      $("#reddit_news").rss("http://www.reddit.com/r/DAS/.rss", settingsReddit, NRS.newsLoaded);
      $("#dascoin_blogspot_news").rss("http://dascoin.blogspot.com/feeds/posts/default", settings, NRS.newsLoaded);
      $("#daser_news").rss("http://daser.org/feed/", settings, NRS.newsLoaded);
		NRS.pageLoaded();
	};
