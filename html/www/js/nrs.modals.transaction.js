...
var NRS = (function (NRS, $, undefined) {
                                ...
                                if (!response.errorCode) {
                                    if (transaction.recipient != response.buyer || transaction.attachment.priceNQT != response.priceNQT) {
                                        ...
                                        message = $.t("alias_sale_direct_offer", {
                                            "das": NRS.formatAmount(transaction.attachment.priceNQT)
                            ...
                            if (transaction.attachment.asset) {
                                NRS.sendRequest("getAsset", {
                                    ...
                                    data = {
                                        ...
                                        "asset_name": asset.name,
                                        "quantity": [transaction.attachment.quantityQNT, asset.decimals],
                                        "price_formatted_html": NRS.formatOrderPricePerWholeQNT(transaction.attachment.priceNQT, asset.decimals) + " DAS",
                                        "total_formatted_html": NRS.formatAmount(NRS.calculateOrderTotalNQT(transaction.attachment.quantityQNT, transaction.attachment.priceNQT)) + " DAS"
                                    };
                                    data["sender"] = transaction.senderRS ? transaction.senderRS : transaction.sender;
                                    infoTable.find("tbody").append(NRS.createInfoTable(data));
                                    infoTable.show();
                            ...
                            if (transaction.attachment.asset) {
                                NRS.sendRequest("getAsset", {
                                    ...
                                    data = {
                                        ...
                                        "asset_formatted_html": NRS.getTransactionLink(transaction.attachment.asset),
                                        "asset_name": asset.name,
                                        "amount_per_share": NRS.formatOrderPricePerWholeQNT(transaction.attachment.amountNQTPerQNT, asset.decimals) + " DAS",
                    ...
                    case 2:
                        ...
                        NRS.sendRequest("getDGSGood", {
                            ...
                            data = {
                                ...
                                "item_name": goods.name,
                                "new_price_formatted_html": NRS.formatAmount(transaction.attachment.priceNQT) + " DAS",
                                "seller": NRS.getAccountFormatted(goods, "seller")
                            };
                        ...
                        NRS.sendRequest("getDGSPurchase", {
                            ...
                            NRS.sendRequest("getDGSGood", {
                                ...
                                if (purchase.quantity != "1") {
                                    ...
                                    data["total_formatted_html"] = orderTotal + " DAS";
                                }
                    ...
                    case 7:
                        ...
                        NRS.sendRequest("getDGSPurchase", {
                            ...
                            NRS.sendRequest("getDGSGood", {
                                ...
                                data["order_total_formatted_html"] = NRS.formatAmount(orderTotal) + " DAS";
                ...
                switch (transaction.subtype) {
                    case 0:
                        ...
                        data = {
                            ...
                            "min_reserve_per_unit_formatted_html": NRS.formatAmount(minReservePerUnitNQT) + " DAS",
                        ...
                        if (currency) {
                            ...
                            data["current_reserve_per_unit_formatted_html"] = NRS.formatAmount(currentReservePerUnitNQT) + " DAS";
                        } else {
                    ...
                    case 1:
                        if (currency) {
                            ...
                            data = {
                                ...
                                "amount_per_unit_formatted_html": NRS.formatAmount(amountPerUnitNQT) + " DAS",
                                "reserved_amount_formatted_html": NRS.formatAmount(NRS.calculateOrderTotalNQT(amountPerUnitNQT, NRS.convertToQNTf(resSupply, currency.decimals))) + " DAS"
                            };
                        } else {
                    ...
                    case 2:
                        if (currency) {
                            ...
                            data = {
                                ...
                                "claimed_amount_formatted_html": NRS.formatAmount(NRS.convertToQNTf(NRS.calculateOrderTotalNQT(reservePerUnitNQT, transaction.attachment.units), currency.decimals)) + " DAS"
                            };
                        } else {
                            data = NRS.getUnknownCurrencyData(transaction);
                        }
    ...
    NRS.formatAssetOrder = function (asset, transaction, isModalVisible) {
        ...
        NRS.sendRequest("getOrderTrades", params, function (response) {
            ...
            data["total_traded"] = NRS.formatAmount(tradeTotal, false, true) + " DAS";
        }, { isAsync: false });
    ...
    NRS.formatCurrencyExchange = function (currency, transaction, type) {
        var rateUnitsStr = " [ " + currency.code + " / DAS ]";
        var data = {
        ...
        NRS.sendRequest("getExchangesByExchangeRequest", {
            ...
            data["total_exchanged"] = NRS.formatAmount(exchangedTotal, false, true) + " [DAS]";
        }, { isAsync: false });
        return data;
    };
