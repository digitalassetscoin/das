const options = {
    url: "http://localhost:6876", // URL of DAS remote node
...
exports.load = function(callback) {
    ...
    require("jsdom").env("", function(err, window) {
        try {
            ...
            // the DAS client was note designed with modularity in mind there we have
            ...
            // Now load some DAS specific libraries into the global scope
            global.DasAddress = require('./util/dasaddress');
            ...
            // however the DAS client relies on a global browser scope which defines the NRS object
