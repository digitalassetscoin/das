...
var NRS = (function(NRS, $) {
	var index = 0;
	var bundles = [
		{alias: "nrsVersion", status: "release", prefix: "das-client-", ext: "zip"},
		{alias: "nrsBetaVersion", status: "beta", prefix: "das-client-", ext: "zip"},
		{alias: "nrsVersionWin", status: "release", prefix: "das-client-", ext: "exe"},
		{alias: "nrsBetaVersionWin", status: "beta", prefix: "das-client-", ext: "exe"},
		{alias: "nrsVersionMac", status: "release", prefix: "das-installer-", ext: "dmg"},
		{alias: "nrsBetaVersionMac", status: "beta", prefix: "das-installer-", ext: "dmg"},
		{alias: "nrsVersionLinux", status: "release", prefix: "das-client-", ext: "sh"},
		{alias: "nrsBetaVersionLinux", status: "beta", prefix: "das-client-", ext: "sh"}
	];
	...
	NRS.downloadClientUpdate = function(status, ext) {
        ...
        var fileurl = "https://bitbucket.org/JeanLucPicard/das/downloads/" + filename;
