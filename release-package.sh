...
then
echo obfuscate
/opt/proguard/bin/proguard.sh @das.pro
...
cd -
zip -q -X -r ${PACKAGE}.zip das -x \*/.idea/\* \*/.gitignore \*/.git/\* \*/\*.log \*.iml das/conf/das.properties das/conf/logging.properties das/conf/localstorage/\*
rm -rf das
...
echo >> ${CHANGELOG}
echo "https://bitbucket.org/JeanLucPicard/das/downloads/${PACKAGE}.zip" >> ${CHANGELOG}
echo >> ${CHANGELOG}
...
echo >> ${CHANGELOG}
echo "https://bitbucket.org/JeanLucPicard/das/downloads/${PACKAGE}.sh" >> ${CHANGELOG}
echo >> ${CHANGELOG}
echo "sha256:" >> ${CHANGELOG}
echo >> ${CHANGELOG}
...
echo >> ${CHANGELOG}
echo "https://bitbucket.org/JeanLucPicard/das/downloads/${PACKAGE}.exe" >> ${CHANGELOG}
echo >> ${CHANGELOG}
#echo "sha256:" >> ${CHANGELOG}
#sha256sum ${PACKAGE}.exe >> ${CHANGELOG}
echo "https://bitbucket.org/JeanLucPicard/das/downloads/das-installer-${VERSION}.dmg" >> ${CHANGELOG}
echo >> ${CHANGELOG}

echo "The exe, dmg, and sh packages must have a digital signature by \"Stichting DAS\"." >> ${CHANGELOG}
